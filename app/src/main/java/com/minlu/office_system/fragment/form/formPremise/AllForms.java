...
public enum AllForms {
    ...
    * */
    ...
    BUS_MANAGEMENT("车辆管理", R.mipmap.home_page_icon4, BusManagementFragment.class, StringsFiled.SHOW_SUBMIT_BUTTON, StringsFiled.BusManagementFragment_TAG),
    PLAN_SUMMARY("计划总结", R.mipmap.home_page_icon5, PlanSummaryFragment.class, StringsFiled.SHOW_IS_AGREE_BUTTON, StringsFiled.PlanSummaryFragment_TAG),
