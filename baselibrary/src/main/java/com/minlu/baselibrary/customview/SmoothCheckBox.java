...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs, Context Context) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, ViewsUitls.dpToPx(mContext, 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = ViewsUitls.dpToPx(mContext,DEF_DRAW_SIZE);
